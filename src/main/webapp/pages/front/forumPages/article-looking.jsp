                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body">
                                ...
                                <c:if test="${not empty article.photo}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <img style="width: 80%;" src="${article.photo}">
                                        </div>
                                    </div>
                                </c:if>
                                <!-- /.box -->
                                ...
                                <form action="${pageContext.request.contextPath}/forum/reply" method="post">
                                    <div class="col-md-10 data editer">
                                        <hr>
                                        <textarea class="textarea" name="pcontent" style="width: 98%; height: 265px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                        <input type="hidden" name="fid" value="${article.fid}" />
                                        <input type="hidden" name="uid" value="${loginUser.id}" />
                                        <input type="hidden" name="nickname" value="${loginUser.nickname}" />
                                        <br>
                                        <button type="submit" onclick="return checkLogin();" class="btn btn-block btn-info" style="width: 8%;">回帖
                                        </button>
                                    </div>
                                </form>
                            </div>
