                                ...
                                <tr>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">${rule.linkname}</h4>
                                                </div>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                data-toggle="modal" data-target="#myModal${rule.id}">内容
                                        </button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="window.open('${pageContext.request.contextPath}/rule/revise?rid=${rule.id}')">修改</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="window.location.href='${pageContext.request.contextPath}/rule/delete?rid=${rule.id}'">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
